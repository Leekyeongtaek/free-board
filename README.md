...
## 프로젝트 목적과 주제
- 학습한 JPA, QueryDSL 기술을 직접 사용해서 프로젝트 만들어보기
...
- 댓글 기능
  ...
  - 좋아요 등록/삭제
- 공통 기능
  - 치명적 예외 발생하거나 API 응답 시간이 1.5초를 초과하는 경우 관리자에게 로그를 확인하라는 경고 메일을 전송
...
- 댓글 기능
  - 목록 조회
    - 페이징 기능
    - 게시글 작성자 여부를 나타내는 필드를 포함한다
    - 좋아요 여부를 나타내는 필드를 포함한다
    - 대댓글의 개수를 나타내는 필드를 포함한다
